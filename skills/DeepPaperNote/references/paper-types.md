...
section_semantics:
- 研究問題: 方法要解決的具體技術問題、現有研究路線，以及既有方法短板。
...
section_semantics:
- 研究問題: 這個 benchmark/dataset 想補足的評測或資料缺口，以及現有資料或評測路線的不足。
...
section_semantics:
- 研究問題: 臨床、心理學或行為科學中的研究問題、假設或變數關係，以及重要前人研究背景。
...
section_semantics:
- 研究問題: 作者要解釋的社會、文化、歷史、制度或理論問題，以及相關理論或經典研究背景。
...
section_semantics:
- 研究問題: 綜述試圖整理的領域問題、爭議或知識缺口，以及代表性文獻路線。
